...
2. **Class 1 (Declarative SSOT)**: [`versions.json`](https://github.com/cordanaLLM/nucleus/blob/main/versions.json) is the sole authority for kernel versions, release tags, upstream tarball URLs, and supported architectures.
